...
public class GWBISDestinationAssembler extends AbstractXMLAssembler  {

	public GWBISDestinationAssembler() {
	...
	public String assemble(String xmlMsg, String key, List<String> valueList) {
		...
		return xmlMsg.substring(0, sPosMsg) + sKey + "<expected_payout_amount>" + valueList.get(0) + "</expected_payout_amount><currency_iso_code>" + valueList.get(1) + "</currency_iso_code><country_iso_code>" + valueList.get(2) + eKey +xmlMsg.substring(ePosMsg);
	}
}
